...
const UNIVERSIDADES = {
  ...
  inacap: {
    nombre: "INACAP",
    aliases: [
      "INACAP", "CENTRO DE FORMACIÓN TÉCNICA INACAP", "INSTITUTO PROFESIONAL INACAP",
      "UNIVERSIDAD TECNOLÓGICA DE CHILE INACAP", "CFT INACAP", "IP INACAP",
      "FORMACIÓN TÉCNICA INACAP", "PROFESIONAL INACAP",
    ],
    tipo: "online",
    url: "https://siga.inacap.cl/Inacap.VerificacionCertificados",
    campos: ["codigo"],
  },
  ...
  uv: {
    ...
    aliases: [
      "UNIVERSIDAD DE VALPARAÍSO", "UNIVERSIDAD DE VALPARAISO", "U. DE VALPARAÍSO",
      "UV", "U VALPARAISO",
    ],
    tipo: "online",
    url: "https://verificacertificado.uv.cl",
    campos: ["codigo"],
  },
  ...
  ubolivariana: {
    ...
    aliases: [
      "UNIVERSIDAD BOLIVARIANA", "U. BOLIVARIANA", "BOLIVARIANA",
    ],
    tipo: "online",
    url: "https://certificados.ubolivariana.cl/validacertificado.aspx",
    campos: ["codigo"],
  },
};
